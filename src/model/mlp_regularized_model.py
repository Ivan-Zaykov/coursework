...
def build_mlp_regularized(input_shape=(784,), num_classes=10, l2_reg=0.0, dropout_rate=0.2):
...
def train_mlp_regularized():
    try:
        ...
        if os.path.exists(model_path):
            ...
            model = build_mlp_regularized(l2_reg=BEST_PARAMS["l2_reg"],
            ...
            results_logger.info("Training MLP Regularized model with optimized hyperparameters...")
